...
* **Classes Abstratas:** Implementação da classe base `Operacao`, que define um contrato obrigatório para todas as operações matemáticas através de métodos abstratos.
...
Atenção, Professor! Mantendo a tradição, há um Easter Egg pelas mensagens sobre algo bemmm popular...
